package com.huliang.oschn.open.constants;
...
public interface OpenConstant {
    ...
    String OSC_APP_ID = "9feJ3SlyCbeQ9RLd6fdk";
    String OSC_APP_KEY = "nuzz8feGObiSbTHOGVWAwwpMyJgJnFv0";
    String OSC_APP_REDIRECT_URL = "http://sns.whalecloud.com/sina2/callback";

    /**
     *
     状态	正在审核
     应用ID	9feJ3SlyCbeQ9RLd6fdk
     应用私钥	nuzz8feGObiSbTHOGVWAwwpMyJgJnFv0重置
     应用首页
     回调地址	http://sns.whalecloud.com/sina2/callback
     配额	2000/0.000%
     */
